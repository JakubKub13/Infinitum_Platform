...
contract MockLotteryFunctions is Ownable, VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory randomWords) internal override {
        ...
        uint256 winningNum = (randomWords[0] % totalIds) + 1;
    ...
    //function testWinningNumber0() public {
    //    requestIdToCount[__requestId] = lotteryCount;
    //    testFulfillRandomWords(__requestId, 0);
    ...
    //    requestIdToCount[__requestId] = lotteryCount;
    //    testFulfillRandomWords(__requestId, 99);
    //    emit LotteryStart(lotteryCount, __requestId);
    //    lotteryCount++;
    //}

    //function testFulfillRandomWords(uint256 __RequestId, uint256[] memory randomWords) public {
    //    uint totalIds = infinitasFactory.getTotalSupply();
    //    uint256 winningNum = (randomWords[0] % totalIds) + 1;
